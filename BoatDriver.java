...
{
    /**
     * main method runs tests to ensure 
     * the program for reserving a boat
     * is properly working. 
     * 
     * @param args
     */
    ...
    {
        ResManager<Boat, Reservation> manager = 
            new ResManager<Boat, Reservation>();
        try 
        {
            Scanner scanner = new Scanner
                (new FileInputStream("boatFile.txt"));
